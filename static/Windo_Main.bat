...
echo Windows Server 2012 R2를 기준으로 제작된 코드입니다. >>  W1~82\report.txt
echo 이하 버전에 대해서는 점검이 정상진행 되지 않을 수 있습니다. >>  W1~82\report.txt
...
echo W1~82\log\[W-03]account.txt파일을 확인후 "net user 계정명 /delete" 을 입력하여 >>  W1~82\report.txt
echo 불필요한 계정을 제거하시오 >>  W1~82\report.txt
...
echo [W-31] 최신 서비스팩이 설치되지 않거나, 적용 절차 및 방법이 수립되지 않은 경우 - [취약] > W1~82\bad\[W-31S]bad.txt
echo [W-31] 최신 서비스팩이 설치되지 않거나, 적용 절차 및 방법이 수립되지 않은 경우 - [취약] >> W1~82\report.txt
...
echo 시작-실행-Winver입력 >> W1~82\report.txt
echo 서비스팩 버전 확인 후 최신 버전이 아닌 경우 "https://support.microsoft.com/ko-kr/lifecycle/search"에서 최신 서비스팩 다운로드 후 설치 또는 자동업데이트를 활용해주세요. >> W1~82\report.txt
echo ※인터넷 웜이 Windows의 취약점을 이용하여 공격하기 때문에 서비스팩 설치시에는 네트워크와 분리된 상태에서 설치 할 것을 권장합니다.※ >> W1~82\report.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 서비스 항목에 수동으로 12점을 부여해 주십시오. >> W1~82\report.txt
...
echo [W-32] 최신 HotFix가 있는지 주기적으로 모니터 절차가 없거나, 최신 HotFix를 반영하지 않은 경우, 또한 PMS(Patch Management System) Agent가 설치되어 있지 않거나, 설치되어 있으나 자동패치배포가 적용되지 않은 경우 - [취약] >> W1~82\bad\[W-32S]bad.txt
echo [W-32] 최신 HotFix가 있는지 주기적으로 모니터 절차가 없거나, 최신 HotFix를 반영하지 않은 경우, 또한 PMS(Patch Management System) Agent가 설치되어 있지 않거나, 설치되어 있으나 자동패치배포가 적용되지 않은 경우 - [취약] >> W1~82\report.txt
...
echo 수동 HOT FIX 적용 방법 >> W1~82\report.txt
echo "https://technet.microsoft.com/ko-kr/security/"에서 패치 리스트를 조회하여, 서버에 필요한 패치를 선별하여 수동으로 설치 >> W1~82\report.txt
echo. >> W1~82\report.txt
echo 자동 HOT FIX 적용 >> W1~82\report.txt
echo Windows 자동 업데이트 기능을 이용한 설치 >> W1~82\report.txt
echo 제어판-windows update >> W1~82\report.txt
echo. >> W1~82\report.txt
echo PMS설치 >> W1~82\report.txt
echo Agent를 설치하여 자동으로 업데이트 되도록 설정함 >> W1~82\report.txt
echo ※ 보안패치 및 Hot Fix 경우 적용 후 시스템 재시작을 요구하는 경우가 대부분이므로 관리자는 서비스에 지장이 없는 시간대에 적용할 것. >> W1~82\report.txt
echo ※ 일부 Hot Fix는 수행되고있는 OS 프로그램이나 개발용 Application 프로그램에 영향을 줄 수 있으므로 패치 적용 전 Application 프로그램을 구분하고, 필요하다면 OS 벤더 또는 Application 엔지니어에게 확인 작업을 거친 후 패치를 수행할 것. >> W1~82\report.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 패치 관리 항목에 수동으로 12점을 부여해 주십시오. >> W1~82\report.txt
...
echo 백신 프로그램이 최신 엔진 업데이트가 설치되어 있는지 확인해주세요. - [취약] >> W1~82\bad\[W-33S]bad.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 패치 관리 항목에 수동으로 12점을 부여해 주십시오. >> W1~82\bad\[W-33S]bad.txt
echo 백신 프로그램이 최신 엔진 업데이트가 설치되어 있는지 확인해주세요. - [취약] >> W1~82\report.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 패치 관리 항목에 수동으로 12점을 부여해 주십시오. >>  W1~82\report.txt
...
echo [W-34] 로그 기록에 대해 정기적으로 검토, 분석, 리포트 작성 및 보고 등의 조치가 이루어 지지 않는 경우 - [취약] > W1~82\bad\[W-34S]bad.txt
...
echo [W-34] 로그 기록에 대해 정기적으로 검토, 분석, 리포트 작성 및 보고 등의 조치가 이루어 지지 않는 경우 - [취약] >> W1~82\report.txt
echo 접속기록 등의 보안 로그, 응용프로그램 로그, 시스템 로그기록에 대해 정기적으로 검토, 분석, 리포트 작성 및 보고하십시오. >> W1~82\report.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 로그 관리 항목에 수동으로 12점을 부여해 주십시오. >>  W1~82\report.txt
...
if %errorlevel% EQU 0 (
	...
	echo [W-35] Remote Registry Service를 중지해야합니다. >> W1~82\report.txt
	echo 시작-실행-SERVICES.MSC 입력-Remote Registry-속성 >> W1~82\report.txt
	echo 시작 유형을 사용 안 함, 서비스 상태를 중지로 바꿔주십시오. >> W1~82\report.txt
...
if %errorlevel% EQU 0 (
	...
	echo [W-36] 관리 담당자를 통해 바이러스 백신 프로그램이 반드시 설치하여야 하도록 함 >> W1~82\report.txt
...
echo [W-37] c:windows\system32\config\SAM 속성 보안 찾아 들어가기 >> W1~82\report.txt
echo [W-37] Administrator, System 그룹 외 다른 사용자 및 그룹권한 제거 >> W1~82\report.txt
goto W37
...
if %ScreenSaveActive% EQU 0 (
	...
	echo [W-38-1] 제어판-디스플레이-화면보호기 변경 찾아 들어가기-화면 보호기 활성화 >> W1~82\report.txt
...
if %ScreenSaverIsSecure% EQU 0 (
	...
	echo [W-38-2] 제어판-디스플레이-화면보호기 변경 찾아 들어가기-화면 보호기 암호사용 설정 >> W1~82\report.txt
) else (
...
if %ScreenSaveTimeOut% LEQ 600 (
	...
	echo [W-38-3] 화면 보호기 대기 시간이 10분을 초과한 값으로 설정되어 있는 경우 - [취약] >> W1~82\report.txt
	echo [W-38-3] 제어판-디스플레이-화면보호기 변경 찾아 들어가기 >> W1~82\report.txt
	echo [W-38-3] 화면보호기 활성화-다시 시작할 때 로그온 화면표시 체크-대기시간 10분 설정 >> W1~82\report.txt
)
if %W38S% EQU 1 (
	SET/a SecureScore3 = %SecureScore3%+1
)
...
if %errorlevel% EQU 0 (
	...
	echo [W-39] 시작-실행-SECPOL.MSC-로컬정책-보안옵션 찾아 들어가기 >> W1~82\report.txt
	echo [W-39] 시스템 종료 - 로그온 하지 않고 시스템 종료 허용을 사용 안함으로 설정 >> W1~82\report.txt
  	del log.txt
) else (
...
echo [W-40] 원격 시스템에서 강제로 시스템 종료 정책에 Administrators 외 다른 계정 및 그룹이 존재하는 경우 - [취약] > W1~82\bad\[W-40S]bad.txt 
...
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 보안 관리 항목에 수동으로 12점을 부여해 주십시오. >>  W1~82\report.txt

echo [W-40] 원격 시스템에서 강제로 시스템 종료 정책에 Administrators 외 다른 계정 및 그룹이 존재하는 경우 - [취약] >> W1~82\report.txt
echo [W-40] 시작-실행-SECPOL.MSC-로컬정책-사용자 권한 할당 찾아 들어가기 >> W1~82\report.txt
echo 원격 시스템에서 강제로 시스템 종료 정책에 Administrators 외 다른 계정 및 그룹이 존재할 경우 담당자와 함께 확인 후 제거 >> W1~82\report.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 보안 관리 항목에 수동으로 12점을 부여해 주십시오. >>  W1~82\report.txt
...
if %errorlevel% EQU 0 (
	...
	echo [W-41] 시작-실행-SECPOL.MSC-로컬정책 - 보안옵션 “감사: 보안 감사를 로그할 수 없는 경우 즉시 시스템 종료” 정책을 “사용 안 함” 으로 설정 >> W1~82\report.txt
)
...
if %errorlevel% EQU 0 (
	...
	echo [W-42] 시작-실행-SECPOL.MSC-로컬정책 - 보안옵션 '네트워크 액세스 : SAM 계정과 공유의 익명 열거 허용 안 함' 으로 설정 >> W1~82\report.txt
...
if %errorlevel% EQU 0 (
	...
	echo 시작 - 실행 - REGEDIT - HKLM\Software\Microsoft\Windows NT\CurrentVersion\Winlogon 검색 >> W1~82\report.txt
	echo DWORD - AutoAdminLogon  값을 찾아 값을 0으로 입력 >> W1~82\report.txt
	echo DefaultPassword 엔트리가 존재한다면 삭제  >> W1~82\report.txt
...
if %errorlevel% EQU  0 (
	...
	echo [W-44] 시작 - 실행 - SECPOL.MSC - 로컬정책 - 보안옵션  “장치 : 이동식 미디어 포맷 및 꺼내기 허용” 정책을 “Administrators” 로 설정 >> W1~82\report.txt
)
...
echo [W-45] "데이터 보호를 위해 내용을 암호화" 정책이 선택되어 있지 않은 경우 >> W1~82\bad\[W-45S]bad.txt
...
echo [W-45] "데이터 보호를 위해 내용을 암호화" 정책이 선택되어 있지 않은 경우 >> W1~82\report.txt
echo [W-45] 비인가자 접근 통제가 반드시 필요한 디렉터리에 대해서만 암호화 처리 >> W1~82\report.txt
echo [W-45] 폴더 선택 - 속성 -  [일반] 탭 - 고급 - 고급 특성 - “데이터 보호를 위해 내용을 암호화” 선택 >> W1~82\report.txt
echo [W-45] ※ 폴더 속성 - [보안] 탭에서 허가된 사용자 외에는 폴더 내 파일 접근 불가함 >> W1~82\report.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 보안 관리 항목에 수동으로 12점을 부여해 주십시오. >>  W1~82\report.txt
...
if %errorlevel% EQU 0 (
	...
	echo [W-46] 시작-실행-SELPOL.MSC-로컬정책-보안옵션  >> W1~82\report.txt
	echo [W-46] 'Everyone 사용 권한을 익명 사용자에게 적용' 정책이 '시용 안 함' 으로 설정 >> W1~82\report.txt
...
if %log% LSS 60 (
	...
	echo [W-47] 시작-실행-SELPOL.MSC-계정 정책-계정 잠금 정책 >> W1~82\report.txt
	echo [W-47] 계정 잠금 기간 다음 시간 후 계정 잠금 수를 원래대로 설정 에 대해 각각 ‘60분’ 설정 >> W1~82\report.txt
...
if %errorlevel% EQU 0 (
	...
	echo [W-48] 시작-실행-SECPOL.MSC-계정 정책-암호 정책 >> W1~82\report.txt
	echo [W-48] '암호는 복잡성을 만족해야함'을 사용으로 설정 >> W1~82\report.txt
...
if %log% LSS 8 (
	...
	echo [W-49] 시작-실행-SECPOL.MSC-계정정책-암호정책 >> W1~82\report.txt
	echo [W-49] 최소 암호 길이를 8문자로 설정 >> W1~82\report.txt
) else (
...
if %log% GTR 90 (
	...
	echo [W-50] 시작-실행-SECPOL.MSC-계정정책-암호정책 >> W1~82\report.txt
	echo [W-50] ‘최대 암호 사용 기간’의 다음 이후 암호 만료 기간을 ‘90일’로 설정 >> W1~82\report.txt
...
if %minpw% gtr 0 (
	...
	echo 시작-실행-SECPOL.MSC 입력-계정정책-암호정책 >> W1~82\report.txt
	echo 최소암호사용기간을 1일 이상으로 설정하십시오.※권장 1일※ >> W1~82\report.txt
)
...
if %result% EQU 1 (
	...
	echo [W-52] 시작-실행-SECPOL.MSC 입력-로컬정책-보안옵션 >> W1~82\report.txt
	echo [W-52] "대화형 로그온: 마지막 사용자 이름 표시 안 함"을 "사용"으로 설정하십시오. >> W1~82\report.txt
...
echo "로컬 로그온 허용 정책"에 Administrator, IUSR 외 다른 계정 및 그룹이 존재하면 안됩니다. >> W1~82\bad\[W-53S]bad.txt
...
echo "로컬 로그온 허용 정책"에 Administrator, IUSR 외 다른 계정 및 그룹이 존재하면 안됩니다. >> W1~82\report.txt
echo 시작-실행-SECPOL.MSC입력-로컬정책-사용자권한할당-"로컬 로그온 허용"정책 확인 후 Administrator, IUSR 외의 계정을 제거하십시오. >> W1~82\report.txt
...
if %result% EQU 0 (
	...
	echo [W-54] '네트워크 액세스:익명 SID/이름 변환 허용'정책을 '사용 안 함'으로 설정해야합니다. >> W1~82\report.txt
	echo 시작-실행-SECPOL.MSC입력-로컬정책-보안옵션 >> W1~82\report.txt
	echo '네트워크 액세스: 익명 SID/이름 변환 허용' 정책을 '사용 안 함'으로 설정 >> W1~82\report.txt
...
if %result% GEQ 4 (
	...
	echo [W-55] 최근 암호 기억을 4개 이상으로 설정하십시오. >> W1~82\report.txt
	echo 시작-실행-SECPOL.MSC입력-계정정책-암호정책 >> W1~82\report.txt
	echo '최근 암호 기억'을 4개 이상으로 설정 >> W1~82\report.txt
...
if not %errorlevel% EQU 0 (
 ...
 echo [W-56] 시작 - 실행 - secpol.msc - 로컬 정책 - 보안 옵션 >> W1~82\report.txt
 echo [W-56] "계정 : 콘솔 로그온 시 로컬 계정에서 빈 암호 사용 제한" 정책을 "사용"으로 설정 >> W1~82\report.txt
...
if %errorlevel% EQU 0 (
 ...
 echo [W-57] 제어판 - 사용자 계정 - 관리자 계정 이외의 계정 생성 >> W1~82\report.txt
 echo [W-57] 제어판 - 시스템 - 원격 설정 - [원격] 탭 - [원격 데스크톱] 메뉴 - "사용자 선택" 에서 원격 사용자 지정 후 확인 >> W1~82\report.txt
 ...
 echo [W-57] 제어판 - 사용자 계정 - 관리자 계정 이외의 계정 생성 >> W1~82\report.txt
 echo [W-57] 제어판 - 시스템 - 원격 설정 - [원격] 탭 - [원격 데스크톱] 메뉴 >> W1~82\report.txt
 echo [W-57] "이 컴퓨터에 대한 원격 연결 허용"에 체크 - "사용자 선택" 에서 원격 사용자 지정 후 확인 >> W1~82\report.txt
...
if %errorlevel% EQU 0 (
	...
	echo [W-59] 제어판- 관리 도구- IIS[인터넷 정보 서비스] 관리자- 해당 웹 사이트- [오류 페이지] - [작업] 탭에서 [기능 설정 편집] - 서버 오류 발생 시 다음 반환 항목을 사용자 지정 오류 페이지로 설정 >> W1~82\report.txt
...
echo [W-60] 시작-실행-SERVICES.MSC-SNMP Service 속성-"시작 유형"을 "사용 안함"으로 설정-SNMP 서비스 중지 >> W1~82\report.txt
...
echo [W-61] 시작-실행-SERVICES.MSC-SNMP Service 속성-보안-[인증 트랩 보내기] 앞 체크박스 해제 또는 [받아들인 커뮤니티 이름]에서 public, private 제거 >> W1~82\report.txt
...
if %errorlevel% equ 0 (
	echo [W-62] "인증 트랩 보내기"에 체크가 되어있습니다 >> W1~82\good\[W-62]good.txt
	echo [W-62] "인증 트랩 보내기"에 체크가 되어있습니다 >> W1~82\report.txt
	SET/a ServiceScore = %ServiceScore%+4
	SET/a W62S=1
	SET/a W62S1=1

)	else (
	echo [W-62] "인증 트랩 보내기"에 체크가 되어있지 않습니다 >> W1~82\bad\[W-62]bad.txt
	...
	echo [W-62] "인증 트랩 보내기"에 체크가 되어있지 않습니다 >> W1~82\report.txt
	echo [W-62] ^<인증 트랩 보내기^> >> W1~82\report.txt
	echo 시작-실행-SERVICES.MSC 입력-SNMP Service-속성-보안-"인증 트랩 보내기"에 체크해주세요 >> W1~82\report.txt

)

type inform2.txt | find /i "1"
if %errorlevel% equ 0 (
	echo [W-62] "특정 호스트로부터 SNMP 패킷 받아들이기"로 설정되어 있습니다 >> W1~82\good\[W-62]good.txt
	echo [W-62] "특정 호스트로부터 SNMP 패킷 받아들이기"로 설정되어 있습니다 >> W1~82\report.txt
	SET/a ServiceScore = %ServiceScore%+4
	SET/a W62S=1
	SET/a W62S2=1
)	else (
	echo [W-62] "모든 호스트로부터 SNMP 패킷 받아들이기"로 설정되어 있습니다 >> W1~82\bad\[W-62]bad.txt
	...
	echo [W-62] "모든 호스트로부터 SNMP 패킷 받아들이기"로 설정되어 있습니다 >> W1~82\report.txt
	echo [W-62] ^<특정 호스트로부터 SNMP 패킷 받아들이기 설정법^> >> W1~82\report.txt
	echo 시작-실행-SERVICES.MSC 입력-SNMP Service-속성-보안 >> W1~82\report.txt
	echo "다음 호스트로부터 SNMP 패킷 받아들이기" 체크 후 밑에 추가 버튼을 눌러 호스트를 지정해주세요 >> W1~82\report.txt
)
...
if %errorlevel% EQU 1 (
	...
	echo [W-63] 시작-실행-DNSMGMT.MSC-각 조회 영역-해당 영역-속성-일반-동적 업데이트-없음 선택 >> W1~82\report.txt
)
...
if %errorlevel% EQU 0 (
	...
	echo [W-64] IIS 인터넷 정보 서비스 관리자 - FTP 메시지 - 기본 배너 숨기기 설정 >> W1~82\report.txt
)
...
echo [W-64S] HTTP 헤더 확인 필요 >> W1~82\report.txt
echo [W-64S] SMTP 헤더 확인 필요 >> W1~82\report.txt
...
echo Microsoft 다운로드 센터에서 URL Rewrite 다운로드 후 설치 https://www.iis.net/downloads/microsoft/url-rewrite >> W1~82\report.txt
echo. >> W1~82\report.txt
echo 제어판 - 관리도구 - IIS[인터넷 정보 서비스] 관리자 - 해당 웹 사이트 - [URL 재작성]  >> W1~82\report.txt
echo 작업 탭 - [서버 값 관리 - 서버 변수 보기...] >> W1~82\report.txt
echo 작업 탭 - [추가...]- 서버 변수 추가- 서버 변수 이름: RESPONSE_SERVER  >> W1~82\report.txt
echo [URL 재작성] - 작업 탭 - [규칙 추가...] - 아웃바운드 규칙 - 빈 규칙  >> W1~82\report.txt
echo 이름, 검색 범위, 변수 이름, 패턴 설정 - 적용- 이름(N): Remove Server - 검색 범위: 서버 변수- 변수 이름: RESPONSE_SERVER- 패턴 T: .*  >> W1~82\report.txt
echo. >> W1~82\report.txt
echo. >> W1~82\report.txt
...
echo 시작 - 실행 - cmd - adsutil.vbs 파일이 있는 디렉터리로 이동- 명령어: cd C:\inetpub\AdminScripts- adsutil.vbs를 사용하기 위해 서버 관리자에서 역할 추가 필요 >> W1~82\report.txt
echo [웹 서버IIS-관리 도구- IIS 6 관리 호환성- IIS 6 스크립팅 도구] 설치 필요 >> W1~82\report.txt
echo IIS에서 서비스 중인 SMTP 서비스 목록 확인- 명령어: cscript adsutil.vbs enum /p smtpsvc >> W1~82\report.txt
echo SMTP 서비스에 connectresponse 속성 값에서 배너 문구 수정- 명령어: cscript adsutil.vbs set smtpsvc/1/connectresponse “Banner Text >> W1~82\report.txt
echo SMTP 서비스 재시작- 명령어: net stop smtpsvc 중지- 명령어: net start smtpsvc 시작 >> W1~82\report.txt
...
if %errorlevel% EQU 0 (
	...
	echo [W-65-1] 시작- 실행- cmd- tlntadmn config >> W1~82\report.txt
	echo [W-65-1] tlntadmn config sec = +NTLM -passwd [를 입력하여 passwd 인증 방식을 제외하고 NTLM 인증 방식만 사용] >> W1~82\report.txt
	echo [W-65-1] 불필요 시 해당 서비스 제거 - 시작-  실행 - SERVICES.MSC - Telnet - 속성 [일반] 탭에서 "시작 유형"을 "사용 안 함"으로 설정한 후 Telnet 서비스 중지 >> W1~82\report.txt
) else (
	...
	echo [W-65] 불필요 시 해당 서비스 제거 - 시작 - 실행 - SERVICES.MSC - Telnet = 속성 [일반] 탭에서 "시작 유형"을 "사용 안 함"으로 설정한 후 Telnet 서비스 중지 >> W1~82\report.txt
)
...
echo [W-66] 사용하지 않는 불필요한 ODBC 데이터 소스 제거 > W1~82\bad\[W-66S]bad.txt
...
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 서비스 항목에 수동으로 9점을 부여해 주십시오. >> W1~82\report.txt

echo [W-66] 사용하지 않는 불필요한 ODBC 데이터 소스 제거 >> W1~82\report.txt
echo [W-66] 시작 - 설정 - 제어판 - 관리 도구 - ODBC 데이터 원본 - 시스템 DSN - 해당 드라이브 클릭 >> W1~82\report.txt
echo 사용하지 않는 데이터 소스 제거 >> W1~82\report.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 서비스 항목에 수동으로 9점을 부여해 주십시오. >> W1~82\report.txt
...
if %errorlevel% EQU 0 (
	...
	echo  시작 - 실행 - GPEDIT.MSC[로컬 그룹 정책 편집기] >> W1~82\report.txt
	echo  컴퓨터 구성 - 관리 템플릿 - Windows 구성 요소 - 터미널 서비스 - 원격 데스크톱세션 호스트 - 세션 시간 제한 >> W1~82\report.txt
	echo  [활성 상태지만 유휴 터미널 서비스 세션에 시간제한 설정] - [유휴 세션 제한]을 30분으로 설정 >> W1~82\report.txt
)
...
echo 불필요한 명령어나 파일 등 주기적인 예약 작업의 존재 여부를 직접 점검 필요 -[취약] > W1~82\bad\[W-68S]bad.txt
...
echo 불필요한 명령어나 파일 등 주기적인 예약 작업의 존재 여부를 직접 점검 필요 -[취약] >> W1~82\report.txt
echo GUI 확인 방법 - 제어판 - 관리도구 - 작업 스케줄러에서 확인 등록된 예약 작업을 선택하여 상세내역 확인 불필요한 파일 존재 시 삭제 >> W1~82\report.txt
echo CLI의 경우 [W-68]log.txt 참조 >> W1~82\report.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 서비스 항목에 수동으로 9점을 부여해 주십시오. >> W1~82\report.txt
...
if %SystemEvents% == 3 (
 ...
 echo [W-69] 시작 - 실행 - SECPOL.MSC - 로컬 정책 - 감사 정책 >> W1~82\report.txt
 echo [W-69] "시스템 이벤트 감사" 항목 "성공,실패"로 설정 >> W1~82\report.txt
...
if %LogonEvents% == 3 (
 ...
 echo [W-69] 시작 - 실행 - SECPOL.MSC - 로컬 정책 - 감사 정책 >> W1~82\report.txt
 echo [W-69] "로그온 이벤트 감사" 항목 "성공,실패"로 설정 >> W1~82\report.txt
)
...
if %ObjectAccess% == 0 (
 ...
 echo [W-69] 시작 - 실행 - SECPOL.MSC - 로컬 정책 - 감사 정책 >> W1~82\report.txt
 echo [W-69] "개체 액세스 감사" 항목 "감사 안 함"으로 설정 >> W1~82\report.txt
)
...
if %PrivilegeUse% == 0 (
 ...
 echo [W-69] 시작 - 실행 - SECPOL.MSC - 로컬 정책 - 감사 정책 >> W1~82\report.txt
 echo [W-69] "권한 사용 감사" 항목 "감사 안 함"으로 설정 >> W1~82\report.txt
)
...
if %PolicyChange% == 1 (
 ...
 echo [W-69] 시작 - 실행 - SECPOL.MSC - 로컬 정책 - 감사 정책 >> W1~82\report.txt
 echo [W-69] "정책 변경 감사" 항목 "성공"으로 설정 >> W1~82\report.txt
)
...
if %AccountManage% == 1 (
 ...
 echo [W-69] 시작 - 실행 - SECPOL.MSC - 로컬 정책 - 감사 정책 >> W1~82\report.txt
 echo [W-69] "계정 관리 감사" 항목 "성공"으로 설정 >> W1~82\report.txt
)
...
if %ProcessTracking% == 0 (
 ...
 echo [W-69] 시작 - 실행 - SECPOL.MSC - 로컬 정책 - 감사 정책 >> W1~82\report.txt
 echo [W-69] "프로세스 추적 감사" 항목 "감사 안 함"으로 설정 >> W1~82\report.txt
)
...
if %DSAccess% == 1 (
 ...
 echo [W-69] 시작 - 실행 - SECPOL.MSC - 로컬 정책 - 감사 정책 >> W1~82\report.txt
 echo [W-69] "디렉토리 서비스 액세스 감사" 항목 "성공"으로 설정 >> W1~82\report.txt
)
...
if %AccountLogon% == 1 (
 ...
 echo [W-69] 시작 - 실행 - SECPOL.MSC - 로컬 정책 - 감사 정책 >> W1~82\report.txt
 echo [W-69] "계정 로그온 이벤트 감사" 항목 "성공"으로 설정 >> W1~82\report.txt
)
...
if %size% gtr 10480000 (
	...
	echo [W-70] Default가 아닌 다른 로그는 직접확인해야합니다 >> W1~82\report.txt
	echo [W-70] ^<Default가 아닌 다른 로그 확인법^> >> W1~82\report.txt
	echo 시작-실행-EVENTVWR.MSC입력-해당로그-속성-일반 >> W1~82\report.txt
	echo 최대 로그 크기를 10,240 이상으로 설정해주세요 >> W1~82\report.txt
	...
	echo [W-70] 최대 로그 크기 지정 >> W1~82\report.txt
	echo 시작-실행-EVENTVWR.MSC입력-해당로그-속성-일반 >> W1~82\report.txt
	echo 최대 로그 크기를 10,240 이상으로 설정해주세요 >> W1~82\report.txt
	echo [W-70] Default가 아닌 다른 로그는 직접확인해야합니다 >> W1~82\report.txt
	echo [W-70] ^<Default가 아닌 다른 로그 확인법^> >> W1~82\report.txt
...
if %errorlevel% equ 0 (
	...
	echo [W-70] 최대 로그 크기 도달 시 설정 >> W1~82\report.txt
	echo 시작-실행-EVENTVWR.MSC입력-해당로그-속성-일반 >> W1~82\report.txt
	echo "필요한 경우 이벤트 덮어쓰기"에 체크해주세요. >> W1~82\report.txt
	echo [W-70]"필요한 경우 이벤트 덮어쓰기"에 체크해주세요. >> W1~82\report.txt
...
if %errorlevel% equ 0 (
	...
	echo [W-71] 탐색기-로그 디렉토리-속성-보안 >> W1~82\report.txt
	echo Everyone 제거 >> W1~82\report.txt
) else (
...
if %errorlevel% equ 0 (
	...
	echo [W-72] 시작-실행-REGEDIT입력 >> W1~82\report.txt
	echo HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters 검색 >> W1~82\report.txt
	echo 레지스트리 이름 : SynAttackProtect / 레지스트리 값 종류 : REG_DWORD / 유효 범위 : 0, 1, 2 / 권장 설정 값 : 1 또는 2로 설정 >> W1~82\report.txt
	echo 만약 레지스트리가 없으면 추가해주세요 >> W1~82\report.txt
)
...
if %errorlevel% equ 0 (
	...
	echo [W-72] 시작-실행-REGEDIT입력 >> W1~82\report.txt
	echo HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters 검색 >> W1~82\report.txt
	echo 레지스트리 이름 : EnableDeadGWDetect, 레지스트리 값 종류 : REG_DWORD, 유효 범위 : 0, 1 (False, True) >> W1~82\report.txt
	echo 권한 설정 값 : 0으로 (False)로 설정하세요. >> W1~82\report.txt
	echo 만약 레지스트리가 없으면 추가해주세요 >> W1~82\report.txt
)
...
if %errorlevel% equ 0 (
	...
	echo [W-72] 시작-실행-REGEDIT입력 >> W1~82\report.txt
	echo HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters 검색 >> W1~82\report.txt
	echo 레지스트리 이름 : KeepAliveTime / 레지스트리 값 종류 : REG_DWORD >> W1~82\report.txt
	echo 유효 범위 : 1 - 0xFFFFFFFF / 권장 설정 값 : 300,000설정 >> W1~82\report.txt
	echo 만약 레지스트리가 없으면 추가해주세요 >> W1~82\report.txt
)
...
if %errorlevel% equ 0 (
	...
	echo [W-72] 시작-실행-REGEDIT입력 >> W1~82\report.txt
	echo HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters 검색 >> W1~82\report.txt
	echo 유효 범위 : 0, 1 (False, True) / >> W1~82\report.txt
	echo 권장 설정 값 : 1 (True)로 설정 >> W1~82\report.txt
	echo 만약 레지스트리가 없으면 추가해주세요 >> W1~82\report.txt	
)
del dos.txt
del inform.txt
...
if %errorlevel% EQU 0 (
	...
	echo [W-73] 시작-실행-SECPOL.MSC-로컬정책-보안옵션-[장치] 사용자가 프린터 드라이버를 설치할 수 없게함 - 정책을 사용으로 설정 >> W1~82\report.txt
) else (
...
if %errorlevel% EQU 0 (
	...
	echo [W-74-1] 시작-실행-SECPOL.MSC-로컬정책-보안옵션-로그온 시간이 만료되면 클라이언트 연결 끊기- 정책을 사용 안함으로 설정 >> W1~82\report.txt
) else (
...
if %errorlevel% EQU 0 (
	...
	echo [W-74-2] 시작-실행-SECPOL.MSC-로컬정책-보안옵션-세션 연결을 중단하기 전에 필요한 유휴 시간-정책을 15분으로 설정 >> W1~82\report.txt
) else (
       goto W74C
)
...
echo [W-75] 로그인 경고 메시지 제목 및 내용이 설정되어 있지 않은 경우, log 파일을 보고 관리자와 함께 직접확인 요망 - [취약] > W1~82\bad\[W-75S]bad.txt 
...
echo [W-75] 로그인 경고 메시지 제목 및 내용이 설정되어 있지 않은 경우, log 파일을 보고 관리자와 함께 직접확인 요망 - [취약] >> W1~82\report.txt
echo [W-75] 시작-실행-SECPOL.MSC-로컬정책-보안옵션-로그온 시도하는 사용자에 대한 메시지 제목(legalnoticecaption) - 배너 제목입력 >> W1~82\report.txt
echo [W-75] 시작-실행-SECPOL.MSC-로컬정책-보안옵션-로그온 시도하는 사용자에 대한 메시지 텍스트(legalnoticetext) - 배너 내용입력 >> W1~82\report.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 보안 관리 항목에 수동으로 6점을 부여해 주십시오. >>  W1~82\report.txt
...
if %errorlevel% EQU 0 (
 ...
 echo [W-76] 홈C:\사용자\[사용자 계정] >> W1~82\report.txt
 echo [W-76] "All Users, Default USer"에 대한 권한 외 일반계정 삭제 >> W1~82\report.txt
) else (
...
if %errorlevel% EQU 0 (
 ...
 echo [W-77] 시작 - 실행 - SECPOL.MSC - 로컬 정책 - 보안 옵션 >> W1~82\report.txt
 echo [W-77] "네트워크 보안 : LAN Manager 인증 수준" 정책에 "NTLMv2 응답만 보냄" 설정 >> W1~82\report.txt
)
...
if %errorlevel% EQU 0 (
	...
	echo [W-78-1] 시작-실행-SECPOL.MSC-로컬 정책-보안 옵션 >> W1~82\report.txt
	echo [W-78-1] 도메인 구성원: 보안 채널 데이터를 디지털 암호화 또는 서명 정책 '사용'으로 설정 >> W1~82\report.txt
)
...
if %errorlevel% EQU 0 (
	...
	echo [W-78-2] 시작-실행-SECPOL.MSC-로컬 정책-보안 옵션 >> W1~82\report.txt
	echo [W-78-2] 도메인 구성원: 보안 채널 데이터 디지털 서명 정책 '사용'으로 설정 >> W1~82\report.txt
)
...
if %errorlevel% EQU 0 (
	...
	echo [W-78-3] 시작-실행-SECPOL.MSC-로컬 정책-보안 옵션 >> W1~82\report.txt
	echo [W-78-3] 도메인 구성원: 보안 채널 데이터를 디지털 암호화 정책 '사용'으로 설정 >> W1~82\report.txt
)
...
if %errorlevel% EQU 0 (
	...
	echo [W-79] 명령어 프롬프트[DOS창]에서 다음과 같이 입력 >> W1~82\report.txt
	echo [W-79] 시작 - 실행 - CMD - convert C: /fs:ntfs >> W1~82\report.txt
	SET/a W79S=0
) 
...
if %errorlevel% EQU 0 (
	...
	echo [W-79] 명령어 프롬프트[DOS창]에서 다음과 같이 입력 >> W1~82\report.txt
	echo [W-79] 시작 - 실행 - CMD - convert D: /fs:ntfs >> W1~82\report.txt
	SET/a W79S=0
) 
...
if %errorlevel% EQU 0 (
	...
	echo [W-79] 명령어 프롬프트[DOS창]에서 다음과 같이 입력 >> W1~82\report.txt
	echo [W-79] 시작 - 실행 - CMD - convert E: /fs:ntfs >> W1~82\report.txt
	SET/a W79S=0
) 
...
if %errorlevel% EQU 0 (
	...
	echo [W-79] 명령어 프롬프트[DOS창]에서 다음과 같이 입력 >> W1~82\report.txt
	echo [W-79] 시작 - 실행 - CMD - convert F: /fs:ntfs >> W1~82\report.txt
	SET/a W79S=0
) 
...
if %errorlevel% EQU 0 (
	...
	echo [W-80] 시작-실행-SECPOL.MSC-로컬 정책-보안 옵션 >> W1~82\report.txt
	echo [W-80] 도메인 구성원: 컴퓨터 계정 암호 변경 사항 사용 안 함 → 사용 안 함 >> W1~82\report.txt
)
...
if %errorlevel% EQU 0 (
	...
	echo [W-80] 시작-실행-SECPOL.MSC-로컬 정책-보안 옵션 >> W1~82\report.txt
	echo [W-80] 도메인 구성원: 컴퓨터 계정 암호의 최대 사용 기간 → 90일 >> W1~82\report.txt
)
...
echo [W-81] 시작프로그램 목록을 정기적으로 검사하고 불필요한 서비스 체크 해제를 한 경우 (2012 서버 해당 없음) >> W1~82\good\[W-81SS]good.txt
...
echo [W-81] 시작프로그램 목록을 정기적으로 검사하고 불필요한 서비스 체크 해제를 한 경우 (2012 서버 해당 없음) >> W1~82\report.txt
echo [W-81] 시작프로그램 목록을 정기적으로 검사하지 않고, 부팅 시 불필요한 서비스도 실행되고 있는 경우 >> W1~82\report.txt
echo [W-81] 시작 - 검색 - msconfig 명령어 입력 >> W1~82\report.txt
echo [W-81] 시작 프로그램 탭 클릭 - 시작 프로그램 목록 중 불필요하거나 의심스러운 항목 체크 표시 해제 >> W1~82\report.txt
echo 또한, 이 점검부분에서 양호하다고 판단이 된다면, 보안 관리 항목에 수동으로 9점을 부여해 주십시오. >>  W1~82\report.txt
